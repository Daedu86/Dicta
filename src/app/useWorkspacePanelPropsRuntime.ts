...
export function useWorkspacePanelPropsRuntime({
  ...
  const openRouterWorkspaceProps = useOpenRouterWorkspaceProps({
    ...
    directGenerationDurationMinutes,
    onChangeDirectGenerationDurationMinutes: setDirectGenerationDurationMinutes,
    isOnline,
    openRouterOfflineTitle,
    adaptiveOpenRouterBusy,
    topicOpenRouterBusy,
    onGenerateAdaptiveDirectSession: generateAdaptiveNextSessionFromOpenRouter,
    onGenerateTopicDirectSession: generateTopicNextSessionFromOpenRouter,
