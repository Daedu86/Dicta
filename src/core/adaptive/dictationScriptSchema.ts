...
export function normalizeDictationScriptValue(value: unknown): DictationScript {
...
export function collectDictationScriptValidationErrors(value: unknown): string[] {
  const errors: string[] = [];
