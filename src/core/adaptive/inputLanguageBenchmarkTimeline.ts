...
export function buildInputLanguageBenchmarkTimelinePoint(args: InputLanguageBenchmarkTimelinePointArgs): AdaptiveTimelinePoint {
  ...
  return {
    ...
    lagFallbackUsed: args.live.lagFallbackUsed,
    ...
    adaptiveLevel: args.decision.adaptiveLevel,
    adaptiveDirection: args.decision.adaptiveDirection,
    pressureVector: args.decision.pressureVector,
    pacingOutput: args.decision.pacingOutput,
    sampleQuality: args.decision.sampleQuality,
    languageCalibration: args.decision.languageCalibration,
    derivedAdaptiveLabel: args.decision.derivedAdaptiveLabel,
    perceptualPauseLevel: args.decision.perceptualPauseLevel,
    perceptualPauseShortfallMs: args.decision.perceptualPauseShortfallMs,
    trend: args.live.trend,
