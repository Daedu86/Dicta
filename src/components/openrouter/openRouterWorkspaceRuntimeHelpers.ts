...
type OpenRouterWorkspaceExportContext = BuildOpenRouterWorkspaceExportPayloadsArgs & {
...
export function buildOpenRouterWorkspaceExportPayloads(args: BuildOpenRouterWorkspaceExportPayloadsArgs) {
  ...
  return {
    ...
    promptPackage: buildBenchmarkFeedbackPromptPackage(args.exportProfile, args.exportSessionFeedback, llmPrompt, { activeSessionStatus }),
