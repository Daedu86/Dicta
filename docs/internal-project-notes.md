# Dicta Internal Project Notes

This file preserves the detailed technical and operational notes that used to live in the root `README.md`.
...
2. `README.md` for public project overview, setup, and deployment pointers.
3. `docs/internal-project-notes.md` for deeper product terminology, deployment assumptions, and current access/security model.
4. `docs/architecture.md` for topology, data flow, runtime boundaries, and known gaps.
5. `docs/listening-first-architecture.md` for the listening-first score/policy model, Precision/Stabilize/Challenge terminology, and legacy compatibility matrix.
...
If a change updates behavior, keep `AGENTS.md`, `README.md`, `docs/internal-project-notes.md`, and `docs/architecture.md` aligned.
...
Large local working-copy payloads live in IndexedDB, not `localStorage`. `localStorage` is reserved for small manifests, profile pointers, and preferences. See [Storage architecture](storage-architecture.md).
