...
| DictationScript schema | Yes | No | Dicta-built scripts and legacy full OpenRouter JSON still use `easy`, `normal`, `hard`; default OpenRouter output is compact chunks. |
