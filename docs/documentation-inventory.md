...
| `docs/app-shell-modularization-map.md` | REFERENCE | App shell modularization map and remaining extraction guidance. | Refreshed during the Adaptive workspace presentation extraction; verify recent commits and LOC before using. |
...
- `f343991 Extract Browser TTS session environment runtime`
