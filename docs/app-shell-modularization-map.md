...
Updated: 2026-06-11 after Live metrics dock props extraction
...
| Current working-tree App shell LOC | 2683 |
...
- Start the next pass from the clean `ad42cef` baseline before selecting another extraction.
